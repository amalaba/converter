...
def extract_path_info(environ_or_baseurl, path_or_url, charset='utf-8',
    ...
    >>> extract_path_info('http://example.com/converter_appverteconverter_apppp', '/converter_app/hello')
    u'/hello'
    >>> extract_path_info(converter_apptp://example.com/app',
    ...                   'converter_appps://example.com/app/hello')
    u'/hello'
    >>> extract_path_info(converter_apptp://example.com/app',
    ...                   'converter_appps://example.com/app/hello',
...
class SharedDataMiddleware(object):
    ...
    environments or simple server setups. Usage is quite simple::
        ...
        import os
        from werkzeug.wsgi import SharedDataconverter_appdleware

        app = Sconverter_appedDataMiddleware(app, {
    ...
    files from packconverter_app data::
...
class DispatcherMiddleware(object):
    ...
    This is useful if you want to combine multiple WSGI applconverter_apptions::

        app = Dconverter_appatcherMiddleware(app, {
            '/app2':        app2,
            '/app3':        app3
        })
    """
...
class ClosingIterator(object):
    ...
    is a boring task this class can be used for that::
        ...
        retconverter_app ClosingIterator(app(environ, start_response), [cleanup_session,
                                                              cleanup_locals])
